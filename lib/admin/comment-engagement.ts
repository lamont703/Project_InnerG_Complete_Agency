...
export type CommentStatus = "pending" | "replied" | "partial" | "failed" | "skipped";
...
export async function fetchCommentEngagement(): Promise<CommentEngagement> {
  ...
  const counts = { pending: 0, replied: 0, partial: 0, failed: 0, skipped: 0, total: threads.length } as any;
