 ...
 * @property {"lookbook"|"figure"|"hottake"|"newsdesk"} id
...
/** @type {Record<"lookbook"|"figure"|"hottake"|"newsdesk", VideoType>} */
const VIDEO_TYPES = {
  lookbook: {
    id: "lookbook",
    label: "Lookbook",
 ...
 *
 * NOT THE SAME LIST AS THE REGISTRY, and that gap is the point. `newsdesk` is a
 ...
 */
const AGENT_VIDEO_TYPE_IDS = VIDEO_TYPE_IDS.filter((id) => id !== "newsdesk");
