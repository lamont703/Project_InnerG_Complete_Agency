...
export const SEO_KEYWORD_CATALOG: KeywordCategory[] = [
  ...
  // ───────────────────────── INFORMATIONAL ─────────────────────────
  {
    ...
    pages: [
      ...
      { path: "/insights/texas-barber-cosmetology-license-requirements", label: "Texas Barber & Cosmetology License Requirements", keywords: ["texas cosmetology license renewal", "texas barber license renewal", "tdlr cosmetology license renewal", "cosmetology license requirements texas", "Texas cosmetology license reciprocity", "Texas barber license renewal fee", "Texas barber continuing education requirements", "TDLR license lookup", "esthetician vs cosmetologist license Texas"] },
