...
const TRANSITIONS = ["cut", "dissolve", "slide-left", "slide-right", "slide-up", "slide-down"];
...
function cutawayFilters(i, c, o) {
   ...
   */
  const d = Math.min(c.transitionSecs ?? DEFAULT_DUR, c.seconds / 2 - 0.01);
...
module.exports = { cutawayFilters, TRANSITIONS, DEFAULT_DUR };
