...
function bedGraph(o) {
  ...
  /*
   * 0.28, not 0.35, and it was set by ear rather than by meter. A bed is right
   * when you notice the pauses are not silent and never notice the music, which
   * is a judgement no measurement makes for you — the ducking already proves
   * itself in the numbers (a pause lifts ~7.6dB against ~3.8dB under speech)
   * and it still sat a shade loud.
   */
