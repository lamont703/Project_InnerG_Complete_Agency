  ...
  return (
    <div className="min-h-screen light bg-white text-slate-950">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-10 sm:pb-14">
        ...
        <AgentInvite
          ...
          questions={[
            ...
            "What are the Texas eyelash extension licence requirements?",

            "Which schools near me offer eyelash extension training?",

            "Which salons near me are hiring lash artists?",
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph(
            {
            "@type": "FAQPage",
            "@id": `${SITE_URL}/texas-eyelash-extension-practical-exam-kit-list#faqpage`,
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph(
            {
            "@type": "HowTo",
            "@id": `${SITE_URL}/texas-eyelash-extension-practical-exam-kit-list#howto`,
            "isPartOf": ref(WEBSITE_ID),
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph(
            {
            "@type": "ItemList",
            "@id": `${SITE_URL}/texas-eyelash-extension-practical-exam-kit-list#itemlist`, name: "Texas Eyelash Extension Practical Exam Kit List (2026)", itemListElement: KIT_GROUPS.flatMap((g) => g.items).map((item, i) => ({ "@type": "ListItem", position: i + 1, name: item.label })) },
          )) }} />
    </div>
  );
}
