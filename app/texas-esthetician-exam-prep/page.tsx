...
export default function TexasEstheticianExamPrepPage() {
  ...
  return (
    <div className="min-h-screen light bg-white text-slate-950">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "HowTo", name: "Texas Esthetician Practical Exam — Section Order", description: "The 8 timed sections of the Texas esthetician practical exam in order, per the PSI/TDLR Candidate Information Bulletin effective January 1, 2026.", totalTime: "PT1H41M", step: EXAM.sections.map((s, i) => ({ "@type": "HowToStep", position: i + 1, name: s.name, text: [...s.procedure, ...s.safety].join("; ") })) }) }} />
