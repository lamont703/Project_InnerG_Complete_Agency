...
const REQ = findRequirement('mobile-establishment')!;
const SOURCE = TDLR_SOURCES.find((s) => s.id === 'mobile-establishment');

export const metadata = {
  title: 'Texas Mobile Establishment License Requirements (2026)',
  description: "What a Texas mobile establishment licence requires — $78 fee, 2-year term — and the exact TDLR process, sourced from the Department's own application pages.",
  keywords: ["texas mobile establishment license requirements", "how to get a mobile establishment license in texas", "texas mobile establishment license", "mobile establishment license texas cost", "texas mobile establishment license application", "tdlr license requirements texas"],
  openGraph: { title: 'Texas Mobile Establishment License Requirements (2026)', description: "What a Texas mobile establishment licence requires — $78 fee, 2-year term — and the exact TDLR process, sourced from the Department's own application pages." },
  alternates: { canonical: `${SITE_URL}/texas-mobile-establishment-license-requirements-guide` },
};

const FAQS = [
  {
    q: "How many hours do you need for a Texas mobile establishment licence?",
    a: "There is no course-hour requirement \u2014 a mobile establishment licence is a business licence, not a training credential."
  },
  {
    q: "How much does a Texas mobile establishment licence cost?",
    a: "$78 to apply, non-refundable, and the licence is valid two years from the date of issue."
  },
  {
    q: "How long is a Texas mobile establishment licence valid?",
...
export default function TexasMobileEstablishmentRequirementsPage() {
  return (
    <div className="min-h-screen light bg-white text-slate-950">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 pt-28 pb-16">
        ...
        <h1 className="mb-3 text-3xl font-black leading-tight tracking-tight text-slate-950 sm:text-4xl">
          Texas Mobile Establishment License Requirements
        </h1>
        <p className="mb-10 max-w-2xl text-base leading-relaxed text-slate-600 sm:text-lg">
          What TDLR requires to license a mobile establishment licence in Texas — the fee, the conditions, and the deadline that voids applications.
        </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph(
            {
            "@type": "FAQPage",
            "@id": `${SITE_URL}/texas-mobile-establishment-license-requirements-guide#faqpage`,
