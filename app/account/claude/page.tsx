    ...
    <div className="flex min-h-screen flex-col bg-slate-50 light text-slate-900">
      ...
      <main className="flex-1 px-4 pb-20 pt-24 sm:px-6">
        <div className="mx-auto max-w-3xl">
          ...
          {/* The new URL. Its own panel, because it is shown once. */}
          {freshUrl && (
            <section className="mt-8 rounded-2xl border-2 border-emerald-300 bg-emerald-50 p-6">
              ...
              <div className="mt-4 flex items-stretch gap-2">
                <code className="flex-1 overflow-x-auto rounded-xl bg-white px-4 py-3 font-mono text-[13px] text-slate-800">
                  {freshUrl}
                </code>
                <button
                  onClick={copy}
                  className="inline-flex shrink-0 items-center gap-1.5 rounded-xl bg-emerald-700 px-4 text-sm font-black text-white transition hover:bg-emerald-800"
                >
              ...
              <p className="mt-4 flex items-start gap-2 text-xs leading-relaxed text-emerald-900">
                ...
                Treat it like a password. Anyone who has this link can see your listing data and queue
                drafts on your account. It cannot publish to Google, and you can revoke it below at any
                time.
              </p>
            </section>
          )}
          ...
          <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <ol className="mt-2 space-y-1.5 text-sm leading-relaxed text-slate-700">
              <li>1. Open Settings, then Connectors.</li>
              <li>2. Choose to add a custom connector.</li>
              <li>3. Paste your link as the URL and save it.</li>
            </ol>

            <h3 className="mt-5 text-sm font-black uppercase tracking-wide text-slate-500">Claude Code</h3>
            <pre className="mt-2 overflow-x-auto rounded-xl bg-slate-900 px-4 py-3 font-mono text-[13px] text-emerald-300">
{`claude mcp add --transport http shearquery <your link>`}
            </pre>
