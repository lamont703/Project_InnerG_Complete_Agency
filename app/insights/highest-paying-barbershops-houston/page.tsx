      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(graph(
            {
            "@type": "TechArticle",
            "@id": entityId("/insights/highest-paying-barbershops-houston"),
            "about": topics("barbering"),
            "spatialCoverage": stateNode("TX"),
            "isPartOf": ref(WEBSITE_ID),
            "inLanguage": "en-US",
            mainEntityOfPage: ref(pageId("/insights/highest-paying-barbershops-houston")),
            ...
            webPageNode({
              path: "/insights/highest-paying-barbershops-houston",
              name: "Highest Paying Barbershops in Houston | Inner G Complete",
              primaryEntityId: entityId("/insights/highest-paying-barbershops-houston"),
              breadcrumb: true,
              type: "WebPage",
            }),
            breadcrumbNode("/insights/highest-paying-barbershops-houston", [
              { name: "Home", path: "" },
              { name: "Insights", path: "/insights" },
              { name: "Highest Paying Barbershops in Houston | Inner G Complete", path: "/insights/highest-paying-barbershops-houston" },
            ]),
          )),
        }}
      />
