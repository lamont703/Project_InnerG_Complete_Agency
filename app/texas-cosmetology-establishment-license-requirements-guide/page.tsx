...
export const metadata = {
  ...
  alternates: { canonical: "https://agency.innergcomplete.com/texas-cosmetology-establishment-license-requirements-guide" },
};
