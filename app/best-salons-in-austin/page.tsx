...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://agency.innergcomplete.com/best-salons-in-austin",
    type: "article",
  },
  twitter: {
    card: "summary",
  ...
  alternates: { canonical: "https://agency.innergcomplete.com/best-salons-in-austin" },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Best-Rated Salons in Austin", item: "https://agency.innergcomplete.com/best-salons-in-austin" },
            ],
          }),
        }}
      />
