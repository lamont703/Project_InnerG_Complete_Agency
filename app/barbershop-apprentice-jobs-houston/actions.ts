...
// Same haversine formula already used in lib/shop-ecosystem.ts for the
// shop-owner ecosystem report — this is the job-seeker-facing mirror of it.
...
async function geocode(address: string): Promise<{ lat: number; lng: number } | null> {
  ...
  try {
    ...
    console.error("Quiz geocoding failed:", err);
  }
  return null;
}
