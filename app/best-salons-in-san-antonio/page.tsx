...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://agency.innergcomplete.com/best-salons-in-san-antonio",
    type: "article",
  },
  twitter: {
    card: "summary",
  ...
  alternates: { canonical: "https://agency.innergcomplete.com/best-salons-in-san-antonio" },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Best-Rated Salons in San Antonio", item: "https://agency.innergcomplete.com/best-salons-in-san-antonio" },
            ],
          }),
        }}
      />
