...
export default function TexasHairWeavingExamPrepPage() {
  ...
  return (
    <div className="min-h-screen light bg-white text-slate-950">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Course", name: "Texas Hair Weaving Exam Prep", description: 'Every scored criterion on the Texas hair weaving practical exam, the 6 timed sections, and the written exam format — from the Jan 1, 2026 PSI/TDLR bulletin.', url: `${SITE_URL}/texas-hair-weaving-exam-prep`, provider: { "@type": "Organization", name: "Inner G Complete Agency", url: SITE_URL }, teaches: "Texas hair weaving practical exam scored criteria, section order and written exam format", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" } }) }} />
    </div>
  );
}
