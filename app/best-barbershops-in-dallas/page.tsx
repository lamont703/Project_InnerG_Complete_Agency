...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://agency.innergcomplete.com/best-barbershops-in-dallas",
    type: "article",
  },
  twitter: {
    card: "summary",
  ...
  alternates: { canonical: "https://agency.innergcomplete.com/best-barbershops-in-dallas" },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Best Barbershops in Dallas", item: "https://agency.innergcomplete.com/best-barbershops-in-dallas" },
            ],
          }),
        }}
      />
