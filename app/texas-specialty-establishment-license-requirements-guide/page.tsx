...
export const metadata = {
  ...
  alternates: { canonical: "https://agency.innergcomplete.com/texas-specialty-establishment-license-requirements-guide" },
};
