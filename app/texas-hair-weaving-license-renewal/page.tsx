...
export const metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/texas-hair-weaving-license-renewal` },
};
  ...
  return (
    <div className="min-h-screen light bg-white text-slate-950">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 pt-28 pb-16">
        ...
        <AgentInvite questions={questionsForSlug("texas-hair-weaving-license-renewal")!} />
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph(
            {
            "@type": "FAQPage",
            "@id": `${SITE_URL}/texas-hair-weaving-license-renewal#faqpage`,
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(graph(
            {
            "@type": "HowTo",
            "@id": `${SITE_URL}/texas-hair-weaving-license-renewal#howto`,
            "isPartOf": ref(WEBSITE_ID),
            "publisher": ref(ORG_ID), author: authorSchema(), name: "Renew a Texas Hair Weaving License", description: 'Renew your Texas hair weaving specialist license: the $50 fee, 2-year cycle, late-renewal bands and the exact TDLR process — plus what TDLR has not published about CE.', estimatedCost: { "@type": "MonetaryAmount", currency: "USD", value: SPECIALTY_RENEWAL.feeUsd }, step: STEPS.map((s, i) => ({ "@type": "HowToStep", position: i + 1, name: s.t, text: s.d })) },
          )) }} />
    </div>
  );
}
