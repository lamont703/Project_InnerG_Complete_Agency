...
export default function TexasHairWeavingLicenseRenewalPage() {
  return (
    <div className="min-h-screen light bg-white text-slate-950">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "HowTo", author: authorSchema(), name: "Renew a Texas Hair Weaving License", description: 'Renew your Texas hair weaving specialist license: the $50 fee, 2-year cycle, late-renewal bands and the exact TDLR process — plus what TDLR has not published about CE.', estimatedCost: { "@type": "MonetaryAmount", currency: "USD", value: SPECIALTY_RENEWAL.feeUsd }, step: STEPS.map((s, i) => ({ "@type": "HowToStep", position: i + 1, name: s.t, text: s.d })) }) }} />
    </div>
  );
}
