...
import { Star, ArrowRight, Award, Scissors, Building2, UserCheck, GraduationCap, ShoppingBag, Armchair, DollarSign } from "lucide-react";
...
// layout and card design, minus the zip-code drilldown (see city-hub-data.ts
// for why). cityLabel feeds the "View All" search-tool link's query param.
          ...
          {data.sections.map((section) => (
            <div key={section.key} className="bg-white border border-slate-200 rounded-2xl shadow-sm px-6 py-5">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link
                  href={`/tools/barbershop-search?tab=${encodeURIComponent(section.searchTab)}&q=${encodeURIComponent(cityLabel)}`}
