...
const footerLinks = {
  ...
  Tools: [
    ...
    { label: "Shop Site AI Customizer", href: "https://agency.innergcomplete.com/tools/shop-site-template/shop-website-customizer/a6cd48e5-2b32-4062-8284-c100cccdefc3/customizer" },
