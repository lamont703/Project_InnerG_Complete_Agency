...
print("=== TRACING PARSER ON PAGE 21 ===")
current_buffer = ""
unmatched = []
records = []
school_names = {}
        ...
        if score_match:
            ...
            if date_match:
                ...
                if test_match:
                    ...
                    current_buffer = ""
                    continue
        print(f"  [SCORE MATCHED BUT PARSE FAILED]")
        unmatched.append(current_buffer)
        current_buffer = ""
