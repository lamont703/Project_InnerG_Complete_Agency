...
def full_reconstruction():
    ...
    # Robust regex for the roster format
    # 8-digit code, then everything until the name (comma-separated), then the test, date, result, score
    # Note: name can have _, -, spaces
