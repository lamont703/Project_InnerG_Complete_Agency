...
export const CONFIG_TO_SOURCE_TABLES: Record<string, string[]> = {
    ...
    linkedin_data_enabled: ["linkedin_pages", "linkedin_posts", "linkedin_comments"],
    ...
    instagram_data_enabled: ["instagram_accounts", "instagram_media", "instagram_comments"],
    facebook_data_enabled: ["facebook_pages"],
    twitter_data_enabled: ["twitter_accounts", "twitter_tweets"],
    project_metrics_enabled: ["project_metrics_snapshots"],
