ALTER TABLE public.platform_tools ADD COLUMN image_url text DEFAULT '/icon-light-32x32.png';

DROP FUNCTION IF EXISTS public.search_platform_tools_ranked(text, vector, int);
