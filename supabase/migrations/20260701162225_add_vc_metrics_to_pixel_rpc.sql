-- Migration: Add VC Metrics to Pixel Analytics RPC
-- Extends the `get_pixel_analytics_summary` RPC to track "Outbound Leads", "Shop Claims", and "Total Searches"
...
BEGIN
  ...
  INTO 
    v_views, v_clicks, v_active_users, v_engaged_users, v_total_searches, v_outbound_leads, v_shop_claims
  FROM pixel_events
