-- Fixes an ambiguous-column error in compute_professional_employment_matches
-- from the prior migration (20260709000000) — the table/index/RLS setup
-- there already succeeded and doesn't need to run again, only the
-- function needed a fix.
--
...
DROP FUNCTION IF EXISTS compute_professional_employment_matches();
