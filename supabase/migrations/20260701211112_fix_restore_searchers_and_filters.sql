-- Migration: Add AI Mode Metrics to Pixel Analytics RPC
-- Extends the `get_pixel_analytics_summary` RPC to track "AI Mode Activations", "AI Messages Sent", and "AI Rate Limit Hits"
-- while preserving all prior metrics (uniqueSearchers, topFilters, etc.)
