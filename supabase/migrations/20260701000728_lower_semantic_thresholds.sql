-- 1. Lower Semantic Threshold for Barbers
...
BEGIN
  ...
  WHERE 
    ...
    OR (query_embedding IS NOT NULL AND s.semantic_similarity > 0.15) -- Drastically lowered threshold
...
-- 2. Lower Semantic Threshold for Web Search
...
-- 3. Lower Semantic Threshold for Platform Tools
