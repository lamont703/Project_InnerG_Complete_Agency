...
BEGIN
  ...
  SELECT 
    ...
    (
      ...
      -- Engagement Bonus (SMS Agent) - fixed JSONB type mismatch
      (CASE WHEN a.conversation_turns IS NOT NULL OR a.last_conversation_history IS NOT NULL THEN 30 ELSE 0 END) +
