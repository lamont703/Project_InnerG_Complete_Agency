-- Hybrid (semantic + full-text) ranking RPC for barber supply stores,
-- mirroring search_barbershops_ranked's 80/20 alpha weighting.

CREATE OR REPLACE FUNCTION public.search_supply_stores_ranked(
  query_text text,
