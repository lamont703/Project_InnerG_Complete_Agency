-- Hybrid (semantic + full-text) ranking RPC for hair & beauty salons,
-- mirroring search_beauty_supply_stores_ranked's shape (rating/review-volume
-- bonus rather than the barbershop-recruiting-specific fixed multipliers,
-- since agent_salon_leads rows are pure Places directory listings).
