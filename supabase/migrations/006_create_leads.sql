...
CREATE TABLE public.growth_audit_leads (
...
CREATE INDEX idx_growth_audit_leads_status ON public.growth_audit_leads(status, submitted_at DESC);
CREATE INDEX idx_growth_audit_leads_email ON public.growth_audit_leads(email);
